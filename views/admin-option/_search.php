...
/* @var $model app\models\SearchOption */
...
<div class="card block block-rounded block-mode-loading-refresh">
    ...
    <div class="card-body block-content bg-body-light" style="display: none;">
        <div class="search_box option-search">
            <div class="row">
                                <div class="col-sm-4"><?= $form->field($model, 'id') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'route') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'type') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'name') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'content') ?></div>

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'location') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'linked') ?></div>-->
